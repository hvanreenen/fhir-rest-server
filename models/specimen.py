...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Specimen) on 2016-10-07.
...
class Specimen(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.accessionIdentifier = None  #type: identifier.Identifier
        """ Identifier assigned by the lab.
        Type `Identifier` (represented as `dict` in JSON). """
        
        self.collection = None  #type: SpecimenCollection
        """ Collection details.
        Type `SpecimenCollection` (represented as `dict` in JSON). """
        
        self.container = None  #type: SpecimenContainer
        ...
        self.receivedTime = None  #type: fhirdate.FHIRDate
        ...
        self.treatment = None  #type: SpecimenTreatment
...
class SpecimenCollection(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.collectedDateTime = None  #type: fhirdate.FHIRDate
        """ Collection time.
        Type `FHIRDate` (represented as `str` in JSON). """
        
        self.collectedPeriod = None  #type: period.Period
        """ Collection time.
        Type `Period` (represented as `dict` in JSON). """
        
        self.collector = None  #type: fhirreference.FHIRReference
...
class SpecimenContainer(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.additiveCodeableConcept = None  #type: codeableconcept.CodeableConcept
        """ Additive associated with container.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.additiveReference = None  #type: fhirreference.FHIRReference
        """ Additive associated with container.
        Type `FHIRReference` referencing `Substance` (represented as `dict` in JSON). """
        
        self.capacity = None  #type: quantity.Quantity
        ...
        self.specimenQuantity = None  #type: quantity.Quantity
...
class SpecimenTreatment(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.additive = None  #type: fhirreference.FHIRReference
        ...
        self.procedure = None  #type: codeableconcept.CodeableConcept
