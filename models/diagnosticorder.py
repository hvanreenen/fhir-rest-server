...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/DiagnosticOrder) on 2016-10-07.
...
class DiagnosticOrder(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.event = None  #type: DiagnosticOrderEvent
        ...
        self.item = None  #type: DiagnosticOrderItem
...
class DiagnosticOrderEvent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.description = None  #type: codeableconcept.CodeableConcept
