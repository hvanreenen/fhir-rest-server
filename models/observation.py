...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Observation) on 2016-10-07.
...
class Observation(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.component = None  #type: ObservationComponent
        """ Component results.
        List of `ObservationComponent` items (represented as `dict` in JSON). """
        
        self.dataAbsentReason = None  #type: codeableconcept.CodeableConcept
        ...
        self.interpretation = None  #type: codeableconcept.CodeableConcept
        """ High, low, normal, etc..
        Type `CodeableConcept` (represented as `dict` in JSON). """
        ...
        self.referenceRange = None  #type: ObservationReferenceRange
        """ Provides guide for interpretation.
        List of `ObservationReferenceRange` items (represented as `dict` in JSON). """
        
        self.related = None  #type: ObservationRelated
        """ Resource related to this observation.
        List of `ObservationRelated` items (represented as `dict` in JSON). """
        
        self.specimen = None  #type: fhirreference.FHIRReference
...
class ObservationReferenceRange(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.age = None  #type: range.Range
        """ Applicable age range, if relevant.
        Type `Range` (represented as `dict` in JSON). """
        
        self.high = None  #type: quantity.Quantity
        """ High Range, if relevant.
        Type `Quantity` referencing `SimpleQuantity` (represented as `dict` in JSON). """
        
        self.low = None  #type: quantity.Quantity
        """ Low Range, if relevant.
        Type `Quantity` referencing `SimpleQuantity` (represented as `dict` in JSON). """
        
        self.meaning = None  #type: codeableconcept.CodeableConcept
