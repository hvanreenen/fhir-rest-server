...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Provenance) on 2016-10-07.
...
class Provenance(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.activity = None  #type: codeableconcept.CodeableConcept
        """ Activity that occurred.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.agent = None  #type: ProvenanceAgent
        """ Agents involved in creating resource.
        List of `ProvenanceAgent` items (represented as `dict` in JSON). """
        
        self.entity = None  #type: ProvenanceEntity
        ...
        self.recorded = None  #type: fhirdate.FHIRDate
...
class ProvenanceAgent(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.relatedAgent = None  #type: ProvenanceAgentRelatedAgent
