...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/NamingSystem) on 2016-10-07.
...
class NamingSystem(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.contact = None  #type: NamingSystemContact
        ...
        self.replacedBy = None  #type: fhirreference.FHIRReference
        """ Use this instead.
        Type `FHIRReference` referencing `NamingSystem` (represented as `dict` in JSON). """
        
        self.responsible = None  #type: str
        ...
        self.uniqueId = None  #type: NamingSystemUniqueId
