...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Encounter) on 2016-10-07.
...
class Encounter(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.appointment = None  #type: fhirreference.FHIRReference
        """ The appointment that scheduled this encounter.
        Type `FHIRReference` referencing `Appointment` (represented as `dict` in JSON). """
        
        self.class_fhir = None  #type: str
        """ inpatient | outpatient | ambulatory | emergency +.
        Type `str`. """
        
        self.episodeOfCare = None  #type: fhirreference.FHIRReference
        """ Episode(s) of care that this encounter should be recorded against.
        List of `FHIRReference` items referencing `EpisodeOfCare` (represented as `dict` in JSON). """
        
        self.hospitalization = None  #type: EncounterHospitalization
        ...
        self.participant = None  #type: EncounterParticipant
        ...
        self.serviceProvider = None  #type: fhirreference.FHIRReference
        ...
        self.statusHistory = None  #type: EncounterStatusHistory
...
class EncounterHospitalization(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.admitSource = None  #type: codeableconcept.CodeableConcept
        """ From where patient was admitted (physician referral, transfer).
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.admittingDiagnosis = None  #type: fhirreference.FHIRReference
        ...
        self.dietPreference = None  #type: codeableconcept.CodeableConcept
        """ Diet preferences reported by the patient.
        List of `CodeableConcept` items (represented as `dict` in JSON). """
        
        self.dischargeDiagnosis = None  #type: fhirreference.FHIRReference
        """ The final diagnosis given a patient before release from the
        hospital after all testing, surgery, and workup are complete.
        List of `FHIRReference` items referencing `Condition` (represented as `dict` in JSON). """
        
        self.dischargeDisposition = None  #type: codeableconcept.CodeableConcept
        """ Category or kind of location after discharge.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.origin = None  #type: fhirreference.FHIRReference
        """ The location from which the patient came before admission.
        Type `FHIRReference` referencing `Location` (represented as `dict` in JSON). """
        
        self.preAdmissionIdentifier = None  #type: identifier.Identifier
        """ Pre-admission identifier.
        Type `Identifier` (represented as `dict` in JSON). """
        
        self.reAdmission = None  #type: codeableconcept.CodeableConcept
        ...
        self.specialArrangement = None  #type: codeableconcept.CodeableConcept
        """ Wheelchair, translator, stretcher, etc..
        List of `CodeableConcept` items (represented as `dict` in JSON). """
        
        self.specialCourtesy = None  #type: codeableconcept.CodeableConcept
...
class EncounterParticipant(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.individual = None  #type: fhirreference.FHIRReference
