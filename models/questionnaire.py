...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Questionnaire) on 2016-10-07.
...
class Questionnaire(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.group = None  #type: QuestionnaireGroup
        """ Grouped questions.
        ...
        self.subjectType = None  #type: str
...
class QuestionnaireGroup(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.concept = None  #type: coding.Coding
        ...
        self.question = None  #type: QuestionnaireGroupQuestion
        """ Questions in this group.
        List of `QuestionnaireGroupQuestion` items (represented as `dict` in JSON). """
        
        self.repeats = None  #type: bool
...
class QuestionnaireGroupQuestion(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.option = None  #type: coding.Coding
        """ Permitted answer.
        List of `Coding` items (represented as `dict` in JSON). """
        
        self.options = None  #type: fhirreference.FHIRReference
