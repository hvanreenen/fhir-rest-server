...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/NutritionOrder) on 2016-10-07.
...
class NutritionOrder(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.allergyIntolerance = None  #type: fhirreference.FHIRReference
        ...
        self.enteralFormula = None  #type: NutritionOrderEnteralFormula
        """ Enteral formula components.
        Type `NutritionOrderEnteralFormula` (represented as `dict` in JSON). """
        
        self.excludeFoodModifier = None  #type: codeableconcept.CodeableConcept
        """ Order-specific modifier about the type of food that should not be
        given.
        List of `CodeableConcept` items (represented as `dict` in JSON). """
        
        self.foodPreferenceModifier = None  #type: codeableconcept.CodeableConcept
        ...
        self.oralDiet = None  #type: NutritionOrderOralDiet
        ...
        self.supplement = None  #type: NutritionOrderSupplement
...
class NutritionOrderEnteralFormula(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.additiveProductName = None  #type: str
        """ Product or brand name of the modular additive.
        Type `str`. """
        
        self.additiveType = None  #type: codeableconcept.CodeableConcept
        """ Type of modular component to add to the feeding.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.administration = None  #type: NutritionOrderEnteralFormulaAdministration
        """ Formula feeding instruction as structured data.
        List of `NutritionOrderEnteralFormulaAdministration` items (represented as `dict` in JSON). """
        
        self.administrationInstruction = None  #type: str
        """ Formula feeding instructions expressed as text.
        Type `str`. """
        
        self.baseFormulaProductName = None  #type: str
        """ Product or brand name of the enteral or infant formula.
        Type `str`. """
        
        self.baseFormulaType = None  #type: codeableconcept.CodeableConcept
        """ Type of enteral or infant formula.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.caloricDensity = None  #type: quantity.Quantity
        """ Amount of energy per specified volume that is required.
        Type `Quantity` referencing `SimpleQuantity` (represented as `dict` in JSON). """
        
        self.maxVolumeToDeliver = None  #type: quantity.Quantity
        """ Upper limit on formula volume per unit of time.
        Type `Quantity` referencing `SimpleQuantity` (represented as `dict` in JSON). """
        
        self.routeofAdministration = None  #type: codeableconcept.CodeableConcept
...
class NutritionOrderEnteralFormulaAdministration(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.rateQuantity = None  #type: quantity.Quantity
...
class NutritionOrderOralDiet(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.fluidConsistencyType = None  #type: codeableconcept.CodeableConcept
        """ The required consistency of fluids and liquids provided to the
        patient.
        List of `CodeableConcept` items (represented as `dict` in JSON). """
        
        self.instruction = None  #type: str
        """ Instructions or additional information about the oral diet.
        Type `str`. """
        
        self.nutrient = None  #type: NutritionOrderOralDietNutrient
        ...
        self.texture = None  #type: NutritionOrderOralDietTexture
...
class NutritionOrderOralDietTexture(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.foodType = None  #type: codeableconcept.CodeableConcept
