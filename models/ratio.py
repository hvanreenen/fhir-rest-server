...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Ratio) on 2016-10-07.
...
class Ratio(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.denominator = None  #type: quantity.Quantity
        """ Denominator value.
        Type `Quantity` (represented as `dict` in JSON). """
        
        self.numerator = None  #type: quantity.Quantity
        """ Numerator value.
        Type `Quantity` (represented as `dict` in JSON). """
