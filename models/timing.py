...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Timing) on 2016-10-07.
...
class Timing(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.event = None  #type: fhirdate.FHIRDate
        """ When the event occurs.
        List of `FHIRDate` items (represented as `str` in JSON). """
        
        self.repeat = None  #type: TimingRepeat
...
class TimingRepeat(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.boundsPeriod = None  #type: period.Period
        """ Length/Range of lengths, or (Start and/or end) limits.
        Type `Period` (represented as `dict` in JSON). """
        
        self.boundsQuantity = None  #type: quantity.Quantity
        """ Length/Range of lengths, or (Start and/or end) limits.
        Type `Quantity` referencing `Duration` (represented as `dict` in JSON). """
        
        self.boundsRange = None  #type: range.Range
        """ Length/Range of lengths, or (Start and/or end) limits.
        ...
        self.durationMax = None  #type: float
        """ How long when it happens (Max).
        Type `float`. """
        
        self.durationUnits = None  #type: str
        """ s | min | h | d | wk | mo | a - unit of time (UCUM).
        Type `str`. """
        
        self.frequency = None  #type: int
        """ Event occurs frequency times per period.
        Type `int`. """
        
        self.frequencyMax = None  #type: int
        ...
        self.periodMax = None  #type: float
        """ Upper limit of period (3-4 hours).
        Type `float`. """
        
        self.periodUnits = None  #type: str
        """ s | min | h | d | wk | mo | a - unit of time (UCUM).
        Type `str`. """
