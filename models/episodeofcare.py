...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/EpisodeOfCare) on 2016-10-07.
...
class EpisodeOfCare(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.careManager = None  #type: fhirreference.FHIRReference
        """ Care manager/care co-ordinator for the patient.
        Type `FHIRReference` referencing `Practitioner` (represented as `dict` in JSON). """
        
        self.careTeam = None  #type: EpisodeOfCareCareTeam
        ...
        self.referralRequest = None  #type: fhirreference.FHIRReference
        ...
        self.statusHistory = None  #type: EpisodeOfCareStatusHistory
