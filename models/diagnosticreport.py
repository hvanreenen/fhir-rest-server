...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/DiagnosticReport) on 2016-10-07.
...
class DiagnosticReport(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.codedDiagnosis = None  #type: codeableconcept.CodeableConcept
        """ Codes for the conclusion.
        List of `CodeableConcept` items (represented as `dict` in JSON). """
        
        self.conclusion = None  #type: str
        ...
        self.image = None  #type: DiagnosticReportImage
        ...
        self.presentedForm = None  #type: attachment.Attachment
        ...
        self.result = None  #type: fhirreference.FHIRReference
...
class DiagnosticReportImage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.link = None  #type: fhirreference.FHIRReference
