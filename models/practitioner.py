...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Practitioner) on 2016-10-07.
...
class Practitioner(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.communication = None  #type: codeableconcept.CodeableConcept
        ...
        self.practitionerRole = None  #type: PractitionerPractitionerRole
        """ Roles/organizations the practitioner is associated with.
        List of `PractitionerPractitionerRole` items (represented as `dict` in JSON). """
        
        self.qualification = None  #type: PractitionerQualification
...
class PractitionerPractitionerRole(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.healthcareService = None  #type: fhirreference.FHIRReference
