...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/TestScript) on 2016-10-07.
...
class TestScript(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.contact = None  #type: TestScriptContact
        ...
        self.fixture = None  #type: TestScriptFixture
        ...
        self.setup = None  #type: TestScriptSetup
        ...
        self.teardown = None  #type: TestScriptTeardown
        """ A series of required clean up steps.
        Type `TestScriptTeardown` (represented as `dict` in JSON). """
        
        self.test = None  #type: TestScriptTest
        ...
        self.variable = None  #type: TestScriptVariable
...
class TestScriptFixture(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.autocreate = None  #type: bool
        """ Whether or not to implicitly create the fixture during setup.
        Type `bool`. """
        
        self.autodelete = None  #type: bool
        """ Whether or not to implicitly delete the fixture during teardown.
        Type `bool`. """
        
        self.resource = None  #type: fhirreference.FHIRReference
...
class TestScriptMetadata(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.capability = None  #type: TestScriptMetadataCapability
        ...
        self.link = None  #type: TestScriptMetadataLink
...
class TestScriptMetadataCapability(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.conformance = None  #type: fhirreference.FHIRReference
        ...
        self.destination = None  #type: int
...
class TestScriptSetup(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.action = None  #type: TestScriptSetupAction
...
class TestScriptSetupAction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.assert_fhir = None  #type: TestScriptSetupActionAssert
        """ The assertion to perform.
        Type `TestScriptSetupActionAssert` (represented as `dict` in JSON). """
        
        self.operation = None  #type: TestScriptSetupActionOperation
...
class TestScriptSetupActionAssert(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.compareToSourceId = None  #type: str
        """ Id of fixture used to compare the "sourceId/path" evaluations to.
        Type `str`. """
        
        self.compareToSourcePath = None  #type: str
        ...
        self.headerField = None  #type: str
        ...
        self.minimumId = None  #type: str
        """ Fixture Id of minimum content resource.
        Type `str`. """
        
        self.navigationLinks = None  #type: bool
        ...
        self.validateProfileId = None  #type: str
        ...
        self.warningOnly = None  #type: bool
...
class TestScriptSetupActionOperation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.encodeRequestUrl = None  #type: bool
        ...
        self.requestHeader = None  #type: TestScriptSetupActionOperationRequestHeader
...
class TestScriptTeardown(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.action = None  #type: TestScriptTeardownAction
...
class TestScriptTest(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.action = None  #type: TestScriptTestAction
