...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/CarePlan) on 2016-10-07.
...
class CarePlan(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.activity = None  #type: CarePlanActivity
        """ Action to occur as part of plan.
        List of `CarePlanActivity` items (represented as `dict` in JSON). """
        
        self.addresses = None  #type: fhirreference.FHIRReference
        ...
        self.context = None  #type: fhirreference.FHIRReference
        ...
        self.goal = None  #type: fhirreference.FHIRReference
        ...
        self.modified = None  #type: fhirdate.FHIRDate
        """ When last updated.
        ...
        self.participant = None  #type: CarePlanParticipant
        ...
        self.relatedPlan = None  #type: CarePlanRelatedPlan
        ...
        self.support = None  #type: fhirreference.FHIRReference
...
class CarePlanActivity(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.actionResulting = None  #type: fhirreference.FHIRReference
        """ Appointments, orders, etc..
        List of `FHIRReference` items referencing `Resource` (represented as `dict` in JSON). """
        
        self.detail = None  #type: CarePlanActivityDetail
        """ In-line definition of activity.
        Type `CarePlanActivityDetail` (represented as `dict` in JSON). """
        
        self.progress = None  #type: annotation.Annotation
...
class CarePlanActivityDetail(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.dailyAmount = None  #type: quantity.Quantity
        """ How to consume/day?.
        ...
        self.productCodeableConcept = None  #type: codeableconcept.CodeableConcept
        """ What is to be administered/supplied.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.productReference = None  #type: fhirreference.FHIRReference
        """ What is to be administered/supplied.
        Type `FHIRReference` referencing `Medication, Substance` (represented as `dict` in JSON). """
        
        self.prohibited = None  #type: bool
        """ Do NOT do.
        Type `bool`. """
        ...
        self.reasonCode = None  #type: codeableconcept.CodeableConcept
        ...
        self.scheduledString = None  #type: str
        """ When activity is to occur.
        Type `str`. """
        ...
        self.statusReason = None  #type: codeableconcept.CodeableConcept
...
class CarePlanParticipant(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.member = None  #type: fhirreference.FHIRReference
        """ Who is involved.
...
class CarePlanRelatedPlan(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.plan = None  #type: fhirreference.FHIRReference
