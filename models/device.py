...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Device) on 2016-10-07.
...
class Device(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.manufactureDate = None  #type: fhirdate.FHIRDate
        """ Manufacture date.
        Type `FHIRDate` (represented as `str` in JSON). """
