...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Goal) on 2016-10-07.
...
class Goal(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.outcome = None  #type: GoalOutcome
        ...
        self.startCodeableConcept = None  #type: codeableconcept.CodeableConcept
        """ When goal pursuit begins.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.startDate = None  #type: fhirdate.FHIRDate
        """ When goal pursuit begins.
        ...
        self.statusDate = None  #type: fhirdate.FHIRDate
        ...
        self.targetDate = None  #type: fhirdate.FHIRDate
        """ Reach goal on or before.
        Type `FHIRDate` (represented as `str` in JSON). """
        
        self.targetQuantity = None  #type: quantity.Quantity
        """ Reach goal on or before.
...
class GoalOutcome(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.resultCodeableConcept = None  #type: codeableconcept.CodeableConcept
        """ Code or observation that resulted from goal.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.resultReference = None  #type: fhirreference.FHIRReference
        """ Code or observation that resulted from goal.
