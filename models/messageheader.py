...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/MessageHeader) on 2016-10-07.
...
class MessageHeader(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.data = None  #type: fhirreference.FHIRReference
        """ The actual content of the message.
        List of `FHIRReference` items referencing `Resource` (represented as `dict` in JSON). """
        
        self.destination = None  #type: MessageHeaderDestination
        ...
        self.event = None  #type: coding.Coding
        ...
        self.response = None  #type: MessageHeaderResponse
        """ If this is a reply to prior message.
        Type `MessageHeaderResponse` (represented as `dict` in JSON). """
        
        self.responsible = None  #type: fhirreference.FHIRReference
        """ Final responsibility for event.
        Type `FHIRReference` referencing `Practitioner, Organization` (represented as `dict` in JSON). """
        
        self.source = None  #type: MessageHeaderSource
...
class MessageHeaderResponse(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.details = None  #type: fhirreference.FHIRReference
...
class MessageHeaderSource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.contact = None  #type: contactpoint.ContactPoint
