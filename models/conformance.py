...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Conformance) on 2016-10-07.
...
class Conformance(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.acceptUnknown = None  #type: str
        """ no | extensions | elements | both.
        Type `str`. """
        
        self.contact = None  #type: ConformanceContact
        ...
        self.document = None  #type: ConformanceDocument
        """ Document definition.
        ...
        self.implementation = None  #type: ConformanceImplementation
        ...
        self.messaging = None  #type: ConformanceMessaging
        ...
        self.rest = None  #type: ConformanceRest
        """ If the endpoint is a RESTful one.
        List of `ConformanceRest` items (represented as `dict` in JSON). """
        
        self.software = None  #type: ConformanceSoftware
...
class ConformanceMessagingEndpoint(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.protocol = None  #type: coding.Coding
        """ http | ftp | mllp +.
...
class ConformanceRest(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.compartment = None  #type: str
        ...
        self.interaction = None  #type: ConformanceRestInteraction
...
class ConformanceRestOperation(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.definition = None  #type: fhirreference.FHIRReference
...
class ConformanceRestResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.conditionalCreate = None  #type: bool
        """ If allows/uses conditional create.
        Type `bool`. """
        
        self.conditionalDelete = None  #type: str
        """ not-supported | single | multiple - how conditional delete is
        supported.
        Type `str`. """
        
        self.conditionalUpdate = None  #type: bool
        """ If allows/uses conditional update.
        Type `bool`. """
        
        self.interaction = None  #type: ConformanceRestResourceInteraction
        """ What operations are supported?.
        ...
        self.readHistory = None  #type: bool
        """ Whether vRead can return past versions.
        Type `bool`. """
        
        self.searchInclude = None  #type: str
        ...
        self.searchRevInclude = None  #type: str
        ...
        self.updateCreate = None  #type: bool
        """ If update can commit to a new identity.
        Type `bool`. """
        
        self.versioning = None  #type: str
...
class ConformanceRestSecurity(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.certificate = None  #type: ConformanceRestSecurityCertificate
        """ Certificates associated with security profiles.
        List of `ConformanceRestSecurityCertificate` items (represented as `dict` in JSON). """
        
        self.cors = None  #type: bool
        ...
        self.service = None  #type: codeableconcept.CodeableConcept
...
class ConformanceSoftware(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.releaseDate = None  #type: fhirdate.FHIRDate
