...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ImplementationGuide) on 2016-10-07.
...
class ImplementationGuide(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.binary = None  #type: str
        """ Image, css, script, etc..
        List of `str` items. """
        
        self.contact = None  #type: ImplementationGuideContact
        ...
        self.dependency = None  #type: ImplementationGuideDependency
        ...
        self.global_fhir = None  #type: ImplementationGuideGlobal
        ...
        self.package = None  #type: ImplementationGuidePackage
        """ Group of resources as used in .page.package.
        List of `ImplementationGuidePackage` items (represented as `dict` in JSON). """
        
        self.page = None  #type: ImplementationGuidePage
...
class ImplementationGuidePackage(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.resource = None  #type: ImplementationGuidePackageResource
...
class ImplementationGuidePackageResource(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.exampleFor = None  #type: fhirreference.FHIRReference
