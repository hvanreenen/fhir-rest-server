...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Organization) on 2016-10-07.
...
class Organization(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.contact = None  #type: OrganizationContact
...
class OrganizationContact(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.purpose = None  #type: codeableconcept.CodeableConcept
        """ The type of contact.
        Type `CodeableConcept` (represented as `dict` in JSON). """
