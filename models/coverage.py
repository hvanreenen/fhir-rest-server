...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Coverage) on 2016-10-07.
...
class Coverage(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.bin = None  #type: identifier.Identifier
        """ BIN Number.
        Type `Identifier` (represented as `dict` in JSON). """
        
        self.contract = None  #type: fhirreference.FHIRReference
        """ Contract details.
        List of `FHIRReference` items referencing `Contract` (represented as `dict` in JSON). """
        
        self.dependent = None  #type: int
        ...
        self.issuer = None  #type: fhirreference.FHIRReference
        """ An identifier for the plan issuer.
        Type `FHIRReference` referencing `Organization` (represented as `dict` in JSON). """
        
        self.network = None  #type: identifier.Identifier
        """ Insurer network.
        Type `Identifier` (represented as `dict` in JSON). """
        ...
        self.subPlan = None  #type: str
        """ An identifier for the subsection of the plan.
        Type `str`. """
        
        self.subscriber = None  #type: fhirreference.FHIRReference
        """ Plan holder information.
        Type `FHIRReference` referencing `Patient` (represented as `dict` in JSON). """
        
        self.subscriberId = None  #type: identifier.Identifier
        """ Subscriber ID.
        Type `Identifier` (represented as `dict` in JSON). """
