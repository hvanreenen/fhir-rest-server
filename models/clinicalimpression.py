...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/ClinicalImpression) on 2016-10-07.
...
class ClinicalImpression(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.action = None  #type: fhirreference.FHIRReference
        ...
        self.assessor = None  #type: fhirreference.FHIRReference
        ...
        self.finding = None  #type: ClinicalImpressionFinding
        """ Possible or likely findings and diagnoses.
        List of `ClinicalImpressionFinding` items (represented as `dict` in JSON). """
        
        self.investigations = None  #type: ClinicalImpressionInvestigations
        ...
        self.previous = None  #type: fhirreference.FHIRReference
        """ Reference to last assessment.
        Type `FHIRReference` referencing `ClinicalImpression` (represented as `dict` in JSON). """
        
        self.problem = None  #type: fhirreference.FHIRReference
        ...
        self.resolved = None  #type: codeableconcept.CodeableConcept
        """ Diagnoses/conditions resolved since previous assessment.
        List of `CodeableConcept` items (represented as `dict` in JSON). """
        
        self.ruledOut = None  #type: ClinicalImpressionRuledOut
        ...
        self.triggerCodeableConcept = None  #type: codeableconcept.CodeableConcept
        """ Request or event that necessitated this assessment.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.triggerReference = None  #type: fhirreference.FHIRReference
        """ Request or event that necessitated this assessment.
...
class ClinicalImpressionFinding(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.item = None  #type: codeableconcept.CodeableConcept
