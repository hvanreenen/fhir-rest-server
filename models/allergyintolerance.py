...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/AllergyIntolerance) on 2016-10-07.
...
class AllergyIntolerance(domainresource.DomainResource):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.criticality = None  #type: str
        """ CRITL | CRITH | CRITU.
        Type `str`. """
        ...
        self.lastOccurence = None  #type: fhirdate.FHIRDate
        ...
        self.onset = None  #type: fhirdate.FHIRDate
        ...
        self.reaction = None  #type: AllergyIntoleranceReaction
        """ Adverse Reaction Events linked to exposure to substance.
        List of `AllergyIntoleranceReaction` items (represented as `dict` in JSON). """
        
        self.recordedDate = None  #type: fhirdate.FHIRDate
        """ When recorded.
        Type `FHIRDate` (represented as `str` in JSON). """
        
        self.recorder = None  #type: fhirreference.FHIRReference
        """ Who recorded the sensitivity.
        Type `FHIRReference` referencing `Practitioner, Patient` (represented as `dict` in JSON). """
        
        self.reporter = None  #type: fhirreference.FHIRReference
        ...
        self.substance = None  #type: codeableconcept.CodeableConcept
...
class AllergyIntoleranceReaction(backboneelement.BackboneElement):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.exposureRoute = None  #type: codeableconcept.CodeableConcept
        """ How the subject was exposed to the substance.
        Type `CodeableConcept` (represented as `dict` in JSON). """
        
        self.manifestation = None  #type: codeableconcept.CodeableConcept
