...
# -*- coding: utf-8 -*-
#
#  Generated from FHIR 1.0.2.7202 (http://hl7.org/fhir/StructureDefinition/Signature) on 2016-10-07.
...
class Signature(element.Element):
    ...
    def __init__(self, jsondict=None, strict=True):
        ...
        self.when = None  #type: fhirdate.FHIRDate
        """ When the signature was created.
        Type `FHIRDate` (represented as `str` in JSON). """
        
        self.whoReference = None  #type: fhirreference.FHIRReference
